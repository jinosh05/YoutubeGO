...
class SearchSystem:
    search_map = {
        ...
        "home": (0, "Home page: Overview of YoutubeGO, quick start guide, and general information. See the main features and latest updates here."),
        "mp4": (1, "MP4 Page: Download videos in MP4 format. Paste your link and use 'Download Single MP4' or 'Download Playlist MP4' to save videos to your default folder."),
        "mp3": (2, "MP3 Page: Download audio only. Paste your link and use 'Download Single MP3' or 'Download Playlist MP3' to save audio files. Ideal for music and podcasts."),
        ...
        "download": (1, "Use the MP4 or MP3 pages to start your downloads."),
        "audio": (2, "Download audio files using the MP3 page."),
        "video": (1, "Download video files using the MP4 page."),
